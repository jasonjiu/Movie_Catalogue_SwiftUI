...
public class GenreManager: ObservableObject{
    ...
    private let trailerURL = "https://api.themoviedb.org/3/movie/"
    ...
    func loadTrailer(videoId: Int){
        AF.request(trailerURL + String(videoId) + trailerKey + apiKey, method: .get,encoding: JSONEncoding.default).responseJSON{
